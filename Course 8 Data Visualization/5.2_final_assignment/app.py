...
import pandas as pd
from dash import dcc, dash, html, Input, Output, State, no_update
...
airline_data = pd.read_csv(
    "/Users/sylvain/Data Science/Coursera IBM-Data-Science-Professional-Certificate/Course 8 Data Visualization/datasets/airline.csv", index_col=0)
...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Div(
                [
                    html.H2('Report Type:', id="report-type"),
                ]
            ),
    ...
    html.Div(
        [
            html.Div([], id='plot2', className="flex-plot"),
            html.Div([], id='plot3', className="flex-plot")
        ],
        className="flex-plot"
    ),
